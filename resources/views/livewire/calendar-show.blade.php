        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t bg-azul-400">
                    <h3 class="text-xl font-semibold text-azul-100">
                        Adicionar Calendário
                    </h3>
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center" data-modal-hide="AddCalendarModal">
                ...
                <div class="block p-6 space-y-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <label class="relative inline-flex items-center mb-4 cursor-pointer">
                            ...
                            <span class="ml-3 text-sm font-medium text-gray-900">Titulo Padrão "SEMED CALENDÁRIO ESCOLAR EDUCAÇÃO INFANTIL - {{ date('Y')}}"</span>
                        </label>
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b justify-end">
                    ...
                    {{-- <button data-modal-hide="AddCalendarModal" type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"><i class="fa-solid fa-arrow-rotate-right"></i> Gerar</button> --}}
                    <button data-modal-hide="AddCalendarModal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">Cancelar</button>
                </div>
            </div>
        </div>
    </div>
