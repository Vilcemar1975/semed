<div class="flex gap-1 mt-2" class="flex">
    @include('components.botao.verde_a',['title' => "prova", 'route' => "dashatividadeadd", 'icon' => "fa-solid fa-plus text-[12pt] pt-1 pr-2"])
...
<div class="block w-full  border border-azul-100 mt-2 p-3 rounded-lg overflow-hidden">
    <div class="flex bg-azul-400 rounded-md mt-2 text-azul-100">
        ...
        <h3 class="block w-[4rem]  self-center pl-3 font-semibold">Pontos</h3>
    ...
    <div class="list-padrao-clear max-h-[25rem] ">
        @for ($b=0; $b < 12; $b++)
            <div class="flex border text-gray-500 hover:text-azul-100 hover:border-azul-100 hover:bg-azul-400 rounded-lg mt-2">
                <h3 class="block w-[4rem]  self-center pl-3 font-semibold">{{$b}}</h3>
                <h3 class="block w-full   self-center pl-3 font-semibold">Titulo da Prova</h3>
                <h3 class="block w-[6rem]   pl-3 font-semibold">10.0</h3>
                @if ($b % 2 == 1)
