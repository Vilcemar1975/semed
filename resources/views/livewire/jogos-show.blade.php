<div>
    <div class="flex gap-1 mt-2" class="flex">
        @include('components.botao.verde_a',['title' => "Jogos", 'route' => "dashjogosadd", 'icon' => "fa-solid fa-plus text-[12pt] pt-1 pr-2"])
        ...
        <div class="list-padrao-clear max-h-[25rem]">
            @for ($b=0; $b < 12; $b++)
                <div class="flex border hover:border-azul-100 hover:bg-azul-400 rounded-lg mt-2">
                    ...
                    <h3 class="block w-full  text-gray-500 hover:text-azul-100 self-center pl-3 font-semibold">Titulo do Jogos</h3>
                    @if ($b % 2 == 1)
                        <a href="#" class="block w-[4.5rem] text-center text-white text-[14pt] bg-violet-500 hover:bg-violet-600 rounded-s-lg">
                            <i class="relative fa-solid fa-check top-[25%]"></i>
                        </a>
                    @else
                        <a href="#" class="block w-[4.5rem] text-center text-white text-[14pt] bg-gray-500 hover:bg-gray-600 rounded-s-lg">
                            <i class="relative fa-solid fa-xmark top-[25%]"></i>
                        </a>
                    @endif

                    <button class="block w-[4.5rem] text-center text-white text-[14pt] bg-green-600 hover:bg-green-900"
                    data-modal-target="EditArticleModal" data-modal-toggle="EditArticleModal"
                    ><i class="fa-solid fa-pen-to-square"></i></button>
                    <button class="block w-[4.5rem] text-center text-white text-[14pt] bg-red-600 hover:bg-red-900 rounded-br-lg rounded-tr-lg"
