    ...
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 border-transparent text-azul-100 rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="perfil-tab" data-tabs-target="#perfil" type="button" role="tab" aria-controls="perfil" aria-selected="false">Perfil</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 border-transparent text-azul-100 rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="job-tab" data-tabs-target="#job" type="button" role="tab" aria-controls="job" aria-selected="false">Funcionário</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 border-transparent text-azul-100 rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="studante-tab" data-tabs-target="#studante" type="button" role="tab" aria-controls="studante" aria-selected="false">Estudante</button>
            </li>
            <li role="presentation">
                <button class="inline-block p-4 border-b-2 border-transparent text-azul-100 rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="andress-tab" data-tabs-target="#andress" type="button" role="tab" aria-controls="andress" aria-selected="false">Endereço</button>
            </li>
            <li role="presentation">
                <button class="inline-block p-4 border-b-2 border-transparent text-azul-100 rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="protection-tab" data-tabs-target="#protection" type="button" role="tab" aria-controls="protection" aria-selected="false">Segurança</button>
            </li>
        </ul>
    </div>
    <div id="myTabContent">
        {{-- Perfil --}}
        <div class="hidden p-4 rounded-lg bg-gray-50" id="perfil" role="tabpanel" aria-labelledby="perfil-tab">
        ...
        {{-- Funcionário --}}
        <div class="hidden p-4 rounded-lg bg-gray-50" id="job" role="tabpanel" aria-labelledby="job-tab">
        ...
        <div class="hidden p-4 rounded-lg bg-gray-50" id="studante" role="tabpanel" aria-labelledby="studante-tab">
        ...
        {{-- Endereço --}}
        <div class="hidden p-4 rounded-lg bg-gray-50" id="andress" role="tabpanel" aria-labelledby="andress-tab">
        ...
        {{-- Segurança --}}
        <div class="hidden p-4 rounded-lg bg-gray-50" id="protection" role="tabpanel" aria-labelledby="protection-tab">
            <div class="flex gap-2 justify-center mb-3">
                <div class="flex gap-2">
