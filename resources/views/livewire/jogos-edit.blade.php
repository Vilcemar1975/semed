<div>
    <div>
        ...
        <div class="flex gap-2 w-full max-h-[25rem]  mt-2 rounded-lg overflow-hidden">
            <div class="w-full mb-2">
                @include('components.backoffice.label',['idname' => 'game','label' => "Jogo"])
                <div class="flex border border-azul-100 hover:bg-azul-400 rounded-lg mt-2 w-full">
                    ...
                    <h3 class="block w-full  text-gray-500 hover:text-azul-100 self-center pl-3 font-semibold">Arquivo do Jogo</h3>
                    <button class="block w-[4rem] text-center text-white text-[14pt] bg-azul-100 hover:bg-azul-500"
                    data-modal-target="EditJogoModal" data-modal-toggle="EditJogoModal"
                ...
                <p class="text-[9pt] text-gray-500">O Jogo deve ter no maximo 16mb.</p>
                @include('components.backoffice.fildText', ['idname' => "link_game", 'label' => "Link Jogo", 'max' => 0 , 'min' => 0])
                <p class="text-[9pt] text-gray-500">Link de jogo que está em outro servidor.</p>
            ...
            <div class="w-full mb-2">
                ...
                <div class="flex border border-azul-100 hover:bg-azul-400 rounded-lg mt-2 w-full">
                    <img src="{{asset('storage/padrao/img.jpeg')}}" alt="" class="w-[80px] rounded-bl-lg rounded-tl-lg">
                    <h3 class="block w-full  text-gray-500 hover:text-azul-100 self-center pl-3 font-semibold">Imagem de Apresentação</h3>
                    <button class="block w-[4rem] text-center text-white text-[14pt] bg-azul-100 hover:bg-azul-500"
                    data-modal-target="EditJogoModal" data-modal-toggle="EditThumbnailModal"
                    ><i class="fa-solid fa-download"></i></button>
                    <button class="block w-[4rem] text-center text-white text-[14pt] bg-green-500 hover:bg-green-600"
    ...
    <div id="EditJogoModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t bg-azul-400">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center" data-modal-hide="EditJogoModal">
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                    <button data-modal-hide="EditJogoModal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Salvar</button>
                    <button data-modal-hide="EditJogoModal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">Cancelar</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t bg-azul-400">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center" data-modal-hide="EditThumbnailModal">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                        </svg>
                        <span class="sr-only">Fechar Modal</span>
                ...
                <!-- Modal footer -->
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                    <button data-modal-hide="EditThumbnailModal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Salvar</button>
                    <button data-modal-hide="EditThumbnailModal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">Cancelar</button>
                </div>
            </div>
        </div>
    </div>
