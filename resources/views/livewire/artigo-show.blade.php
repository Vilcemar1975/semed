<div>
    ...
    @livewire('plug.list-modulo', [
        'heads' => ['id', 'Titulo',  'Publicado/Editar/Excluir'],
        'lists' => [
                    ['1', 'Texto composição teste para conferir'],
                    ['2', 'Texto composição teste para conferir'],
                    ['3', 'Texto composição teste para conferir'],
                    ['4', 'Texto composição teste para conferir'],
                    ['5', 'Texto composição teste para conferir'],
                    ['6', 'Texto composição teste para conferir'],
                    ['7', 'Texto composição teste para conferir'],
                    ['8', 'Texto composição teste para conferir'],
                    ['9', 'Texto composição teste para conferir'],
                    ['10', 'Texto composição teste para conferir'],
                    ['11', 'Texto composição teste para conferir'],
                    ['12', 'Texto composição teste para conferir'],
                    ['13', 'Texto composição teste para conferir'],
                    ['14', 'Texto composição teste para conferir'],
                    ['15', 'Texto composição teste para conferir'],
                    ['16', 'Texto composição teste para conferir'],
                    ['17', 'Texto composição teste para conferir'],
                    ['18', 'Texto composição teste para conferir'],
                    ['19', 'Texto composição teste para conferir'],
                    ['10', 'Texto composição teste para conferir'],
                ],
        'public' => true,
