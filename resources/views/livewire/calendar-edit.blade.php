<div>
    <div class="flex gap-2 justify-between">
        @include('components.backoffice.fildText', ['idname' => "title", 'label' => "Titulo", 'max' => 0 , 'min' => 0, 'value' => "SEMED CALENDÁRIO ESCOLAR EDUCAÇÃO INFANTIL - 2023"])
        @include('components.backoffice.fildText', ['idname' => "lei", 'label' => "Lei", 'max' => 0 , 'min' => 0, 'value' => $lei ])
    </div>
    <div class="flex gap-2 justify-between">
        @include('components.backoffice.fildText', ['idname' => "author", 'label' => "Autor", 'max' => 0 , 'min' => 0, 'value' => ""])
        @include('components.backoffice.fildselect', ['idname' => "category", 'label' => "Categoria", 'lista' => [], 'selected' => "Ensino Fundamental"])
    </div>

    <div class="flex gap-2 justify-between">
        @include('components.backoffice.text', ['label' => "Data", 'texto' => "Janeiro de 2023"])
        @include('components.backoffice.text', ['label' => "Nivel Escolar", 'texto' => "Ensino Fundamental"])
    </div>
    ...
    <div class="block w-full max-h-[50rem] border border-azul-100 mt-2 p-3 rounded-lg overflow-hidden list-padrao-clear">
        {{-- @include('components.backoffice.calendar.calendario') --}}
        @livewire('calendario', ['menuCalendar' => $menuCalendar])
    </div>
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                    <button data-modal-hide="AddArticleModal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Salvar</button>
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t bg-green-200">
                    ...
                    <button type="button" class="text-green-400 bg-transparent hover:bg-green-900 hover:text-green-400 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center" data-modal-hide="EditArticleModal">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                        </svg>
                        <span class="sr-only">Close modal</span>
                ...
                <div class="p-6 space-y-6">
                    <div class="flex gap-2 justify-between">
                        <div class="block border border-azul-100 px-3 py-1 rounded-lg">
                            @include('components.backoffice.label',['idname' => 'text','label' => "ID"])
                            <p class="text-azul-marinho">99999</p>
                        </div>
                        <div class="block border border-azul-100 px-3 py-1 rounded-lg w-full">
