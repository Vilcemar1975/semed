   ...
   <div id="{{ $idmodal }}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
       <div class="relative w-full max-w-2xl max-h-full">
           ...
           <div class="relative bg-white rounded-lg shadow">
               ...
               <!-- Modal footer -->
               <div class="flex items-center p-6 space-x-2 border-t bg-red-200  border-red-600 rounded-b">
                   <a @if(!empty($route)) href="{{ route($route)}}" @else href="#" @endif data-modal-hide="{{ $idmodal }}" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Excluir</a>
