<div>
    <div class="flex gap-1 mt-2" class="flex">
        @include('components.botao.verde_a',['title' => "Usuário", 'route' => "dashusuariosadd", 'icon' => "fa-solid fa-plus text-[12pt] pt-1 pr-2"])
    ...
    <div class="block w-full  border border-azul-100 mt-2 p-3 rounded-lg overflow-hidden">
        <div class="flex bg-azul-400 rounded-md mt-2 text-azul-100">
            <h3 class="block w-[6rem] self-center pl-3 font-semibold">ID</h3>
            <h3 class="block w-full  self-center pl-3 font-semibold">Titulo</h3>
            <h3 class="block w-[4rem]  self-center pl-3 font-semibold">Ativo</h3>
            <h3 class="block w-[8rem]  self-center pl-3 font-semibold">Permissãos</h3>
        ...
        <div class="list-padrao-clear max-h-[25rem]">
            @for ($b=0; $b < 12; $b++)
                <div class="flex border hover:border-azul-100 hover:bg-azul-400 rounded-lg mt-2">
                    <h3 class="block w-[6rem] text-gray-500 hover:text-azul-100 self-center pl-3 font-semibold">{{$b}}</h3>
                    <h3 class="block w-full  text-gray-500 hover:text-azul-100 self-center pl-3 font-semibold">Nome Completo</h3>
                    @if ($b % 2 == 1)
                    ...
                    @endif
                    <button class="block w-[8rem] text-center text-white text-[14pt] bg-sky-600 hover:bg-sky-900"
                    data-modal-target="EditArticleModal" data-modal-toggle="EditArticleModal"
                    ><i class="fa-solid fa-user-lock"></i></button>
                    <button class="block w-[6rem] text-center text-white text-[14pt] bg-green-600 hover:bg-green-900"
                    data-modal-target="EditArticleModal" data-modal-toggle="EditArticleModal"
