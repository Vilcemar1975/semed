<div>
    ...
    <div id="myTabContent">
        @foreach($menuCalendar as $mes)
            <div class="hidden p-4 rounded-lg bg-gray-50" id="{{ $mes['nick'] }}" role="tabpanel" aria-labelledby="{{$mes['nick']}}-tab">
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody id="table_body">
                        ...
                        @for ($linha=0; $linha < 6; $linha++ )
                            <tr  id="row_{{date('m_y', $startDate)}}" class="relative bg-white border-b div_row" wire:click="pegarDia({{$startDate}})">
                                @for ($col=0; $col < 7; $col++ )
