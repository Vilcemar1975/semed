            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="flex items-start justify-between p-4 border-b rounded-t bg-red-200">
                        ...
                        <button type="button" class="text-red-400 bg-transparent hover:bg-red-900 hover:text-red-400 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center" data-modal-hide="LinkExternaModalExcluir">
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b bg-red-200">
                        <button data-modal-hide="LinkExternaModalExcluir" type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sim</button>
                        <button data-modal-hide="LinkExternaModalExcluir" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">Não</button>
                    </div>
                </div>
            </div>
        </div>
