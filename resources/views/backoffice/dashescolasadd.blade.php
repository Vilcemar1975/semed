    ...
    <div>
        ...
        <div class="mb-4 border-b border-gray-200">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                ...
                <li class="mr-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="foto-tab" data-tabs-target="#foto" type="button" role="tab" aria-controls="foto" aria-selected="false">Foto</button>
                </li>
                <li class="mr-2" role="presentation">
        ...
        <div class="flex flex-wrap gap-2 justify-end">
            ...
            {{-- Foto --}}
            <div class="hidden p-4 rounded-lg bg-gray-50" id="foto" role="tabpanel" aria-labelledby="foto-tab">
